...
public:
	...
	void createProgram(cl::Context& context, cl::Device& device, std::string& kernelFile);
	...
	void makeStep2(u_int particleCount);
	void makeStep3(u_int particleCount, std::vector<numType>& t_dP);
	void makeStep4(numType& t_radius, numType& t_radius2, numType& t_speed, numType& t_gamma, numType& t_gammaSpeed);
