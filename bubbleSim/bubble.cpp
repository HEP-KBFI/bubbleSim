...
Bubble::Bubble(numType t_initialRadius, numType t_initialSpeed, numType t_dV, numType t_sigma) {
	...
	m_area = 4 * M_PI * std::pow(m_radius, 2);
...
numType Bubble::calculateRadiusAfterDt2(numType dt) {
